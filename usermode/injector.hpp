...
void inject(DWORD process_id, DWORD thread_id, LPCWSTR dll_path)
{
...
void pysen(LPCSTR window_class_name, LPCWSTR dll_path)
{
	...
	printf("injecting...%ld %ld\n", process_id, thread_id);

	inject(process_id, thread_id, dll_path);
...
void pysen_pid(DWORD process_id, LPCWSTR dll_path)
{
	// get process id & thread id
	printf("get process\n");
	DWORD thread_id = 0;
	...
	GetThreadIdFromProcessId(process_id);
